...
public:
	...
	//To print the waiting orders and available cooks of each type
	void PrintWaitingAndAvailble(int WaitingVIP, int WaitingNormal, int WaitingVegan, int AvailableVIP, int AvailableNormal, int AvailableVegan) const;
